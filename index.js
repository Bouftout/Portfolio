...
async function main() {
    ...
    const transporter = nodemailer.createTransport({
        ...
        port: 587,
        auth: {
            user: 'davonte.nader94@ethereal.email',
            pass: '5qcXNQ6TxV4ys3kSG5'
        }
    });

    // send mail with defined transport object
    let info = await transporter.sendMail({
        from: '"Davonte Nader" davonte.nader94@ethereal.email', // sender address
        to: "tonitoctoc13@gmail.com", // list of receivers
